 ...
 */
private fun parseSelectorListItems(selector: String): List<SelectorListItem> =
 ...
 */
private fun tryParseViaKss(selector: String): SelectorListItem? {
    return try {
 ...
 */
private fun parseFallback(selector: String): SelectorListItem? {
        ...
        when {
            remaining.startsWith("*") -> {
                simpleSelectors += Selector.Type(
                    location = dev.tonholo.kss.parser.ast.css.syntax.node.CssLocation.Undefined,
                    name = "*",
                )
...
private fun parseAttributeSelector(attrExpr: String): Selector? {
 ...
 */
private fun matchesSelectorListItem(
    element: XastElement,
 ...
 */
private fun matchesSimpleSelector(
    element: XastElement,
    selector: Selector,
