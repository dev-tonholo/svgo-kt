    ...
    val elems: Map<String, SvgElementConfig> = buildMap {
        ...
        put(
            ...
            SvgElementConfig(
                ...
                deprecated = DeprecatedAttrs(
                    unsafe = setOf("horiz-origin-x", "horiz-origin-y", "vert-adv-y", "vert-origin-x", "vert-origin-y")
                ),
                contentGroups = setOf("descriptive"),
        ...
        put(
            ...
            SvgElementConfig(
                ...
                deprecated = DeprecatedAttrs(
                    unsafe = setOf("accent-height", "alphabetic", "ascent", "bbox", "cap-height", "descent", "hanging", "ideographic", "mathematical", "panose-1", "slope", "stemh", "stemv", "unicode-range", "units-per-em", "v-alphabetic", "v-hanging", "v-ideographic", "v-mathematical", "widths", "x-height")
                ),
                contentGroups = setOf("descriptive"),
